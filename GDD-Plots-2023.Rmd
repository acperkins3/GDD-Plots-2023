...
ggplot(Merged, aes(Date, GDDs, group=Field, color=Field)) +
  ...
  annotate("text", x = as.Date("05/29/2023", "%m/%d/%y"), y = 1250, label = "Approximate start of flowering") +
...
ggplot(Merged, aes(Date, GDDs, group=Field, color=Field)) +
  ...
  annotate("text", x = as.Date("05/29/2023", "%m/%d/%y"), y = 2050, label = "~ 35% dry matter silage") +
